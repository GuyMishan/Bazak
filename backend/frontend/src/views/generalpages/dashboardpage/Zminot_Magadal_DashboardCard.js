...
function Zminot_Magadal_DashboardCard(props) {
    ...
    const [cardata_by_magadal_zamin, setCardata_by_magadal_zamin] = useState(0)
    const [cardata_by_magadal_not_zamin, setCardata_by_magadal_not_zamin] = useState(0)
    //
    ...
    function init() {
        ...
        setCardata_by_magadal_zamin(temp_cardata_by_magadal_zamin.length)
        setCardata_by_magadal_not_zamin(temp_cardata_by_magadal_not_zamin.length)
